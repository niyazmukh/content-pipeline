...
import { DEFAULT_PUBLISHER_RSS_FEEDS } from '../../server/retrieval/newsFeeds';
  ...
  const config: AppConfig = {
    ...
    connectors: {
      ...
      googleNewsRss: {
        ...
        publisherFeeds: csv(env.GOOGLE_NEWS_RSS_FEEDS).length ? csv(env.GOOGLE_NEWS_RSS_FEEDS) : DEFAULT_PUBLISHER_RSS_FEEDS,
      },
      newsApi: {
